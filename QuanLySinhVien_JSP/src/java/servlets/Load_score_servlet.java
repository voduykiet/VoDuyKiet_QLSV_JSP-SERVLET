 ...
 * @author DELL
 */
public class Load_score_servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String id_score = request.getParameter("id_update").toString();
        Score s = new Score_DAO().checkId(id_score);
        request.setAttribute("score", s);
        
        ArrayList<Lecturer> list_lec = new Lecturer_DAO().loadLecturer();
        request.setAttribute("list_lecturer", list_lec);
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/session/load_score.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String array_lec[] = id_lecturer.split(" ", id_lecturer.length());
        String id_lecturer1 = array_lec[0];
       ...
       if(new Score_DAO().updateSchoolYear(id_score, Float.parseFloat(score_1), Float.parseFloat(score_4), Float.parseFloat(score_test), Float.parseFloat(avg_score),
           ...
           response.sendRedirect("danh-sach-diem-sinh-vien");
       }

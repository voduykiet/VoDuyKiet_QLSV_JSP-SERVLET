 ...
 * @author DELL
 */
public class Load_individual_score_student_servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String id_score = request.getParameter("id_update");
        String array[] = id_score.split("-", id_score.length());
        Score s = new Score_DAO().checkId(array[0]);
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/session/load_individual_score_student.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_lecturer = request.getParameter("id_update");
        String array[] = id_lecturer.split("-", id_lecturer.length());
        String id_lecturer1 = array[1];
        ...
        if (new Score_DAO().updateSchoolYear(id_score, Float.parseFloat(score_1), Float.parseFloat(score_4), Float.parseFloat(score_test), Float.parseFloat(avg_score),
                id_lecturer1, id_student1, id_subject1, id_credit1, id_category1, id_semester1, id_school_year1) == true) {
            response.sendRedirect("diem-ca-nhan?id_lecturer=" + id_lecturer1);
        }
    }

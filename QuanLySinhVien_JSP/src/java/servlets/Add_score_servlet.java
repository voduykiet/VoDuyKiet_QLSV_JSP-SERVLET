 ...
 * @author DELL
 */
public class Add_score_servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/session/add_score.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Score s = new Score(id_score, Float.parseFloat(score_1), Float.parseFloat(score_4), Float.parseFloat(score_test),
                Float.parseFloat(avg_score), id_lecturer1, id_student1, id_subject1, id_credit1, id_category1, id_semester1, id_school_year1);
